...
describe('AccountSummaryApproverListService', () => {
  let service: AccountSummaryApproverListService;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        AccountSummaryApproverListService,
        {
    ...
    service = TestBed.inject(AccountSummaryApproverListService);
