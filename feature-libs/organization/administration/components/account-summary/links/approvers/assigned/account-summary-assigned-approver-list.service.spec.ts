...
describe('AccountSummaryAssignedApproverListService', () => {
  let service: AccountSummaryAssignedApproverListService;
  let unitService: OrgUnitService;
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule],
      providers: [
        AccountSummaryAssignedApproverListService,
        {
    ...
    service = TestBed.inject(AccountSummaryAssignedApproverListService);
