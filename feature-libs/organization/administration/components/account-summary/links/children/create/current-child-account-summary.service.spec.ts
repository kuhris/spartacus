...
describe('CurrentAccountSummaryChildService', () => {
  let service: CurrentAccountSummaryChildService;
  let unitService: OrgUnitService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [
        CurrentAccountSummaryChildService,
        { provide: RoutingService, useClass: MockRoutingService },
        { provide: OrgUnitService, useClass: MockOrgUnitService },
      ],
    });

    service = TestBed.inject(CurrentAccountSummaryChildService);
