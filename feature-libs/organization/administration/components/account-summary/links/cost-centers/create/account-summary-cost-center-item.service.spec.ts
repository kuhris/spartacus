...
describe('AccountSummaryCostCenterItemService', () => {
  let service: AccountSummaryCostCenterItemService;
  let costCenterService: CostCenterService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [
        AccountSummaryCostCenterItemService,
        {
    ...
    service = TestBed.inject(AccountSummaryCostCenterItemService);
